...
@section('content')
    <div class="container">
        <div class="row shadow-lg p-3 mb-3 mt-3 bg-white rounded">
            <div class="card-body">
            ...
            <div class="col-sm-6 shadow-lg p-3 mb-3 mt-3   bg-white rounded">
                ...
                <div class="form-group">
                    <form action="/sezon/yukla" method="post" id="form" data-parsley-validate ='' enctype="multipart/form-data">
                        ...
                        <input type="file" name="sezon" class="form-control-sm" placeholder="sezon faylni yukalash" required="" data-parsley-max-file-size="1500"
            ...
            <div class="col-sm-6 shadow-lg p-3 mb-3 mt-3  bg-white rounded">
                ...
                <div class="form-group">
                    <input type="file" name="skauting" class="form-control-sm"  required="" data-parsley-max-file-size="1500" aria-describedby="helpId">
